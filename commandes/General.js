 ...
 let sudos = await getAllSudoNumbers()
   ...
   console.log(mentionedJid)
    ...
    const vcard =
        ...
        'VERSION:3.0\n' +
        'FN:' + conf.OWNER_NAME + 'CHARLES verified ✅\n' + // full name
...
zokou({ nomCom: "dev", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    let message = "WELCOME TO CHARLES XMD HELP CENTER! ASK FOR HELP FROM ANY OF THE DEVELOPERS BELOW:\n\n";
